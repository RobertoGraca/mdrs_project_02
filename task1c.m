...
fprintf('Alinea c1\n');
tempo= 10;
[bestLoad,numSolutions,meanSolutions,values] = link_load_greedy_randomized(tempo,nNodes,Links,T,sP,nSP);

figure(2);
hold on;
plot(sort(values));
fprintf('GREEDY RANDOM:\n');
...
hold on;
plot(sort(values));
fprintf('GREEDY RANDOM for 10 best paths:\n');
fprintf('   Best load = %.2f Gbps\n',bestLoad);
fprintf('   No. of solutions = %d\n',numSolutions);
fprintf('   Av. quality of solutions = %.2f Gbps\n',meanSolutions);
...
hold on;
plot(sort(values));
fprintf('GREEDY RANDOM for 5 best paths:\n');
fprintf('   Best load = %.2f Gbps\n',bestLoad);
fprintf('   No. of solutions = %d\n',numSolutions);
fprintf('   Av. quality of solutions = %.2f Gbps\n',meanSolutions);
